...
## Type: QssColor
c.colors.completion.category.bg = xresources["*.color4"]

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = xresources["*.color4"]

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = xresources["*.color4"]
...
## Type: QtColor
c.colors.hints.match.fg = xresources["*.foreground"]
...
## Type: QssColor
c.colors.statusbar.command.private.bg = xresources["*.foreground"]

## Foreground color of the statusbar in private browsing + command mode.
## Type: QssColor
c.colors.statusbar.command.private.fg = xresources["*.background"]
...
## Type: QtColor
c.colors.tabs.even.bg = xresources["*.color9"]
...
## Type: QtColor
c.colors.tabs.odd.bg = xresources["*.color9"]
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = xresources["*.color10"]
...
## are no scrollbars.
## Type: Bool
# c.completion.shrink = False'#F8F8F2'


## Format of timestamps (e.g.'#F8F8F2'

## https://sqlite.org/lang_da'#F8F8F2'
## Type: String
...
## Type: Padding
c.tabs.indicator.padding = {'top': 10, 'bottom': 10, 'left': 0, 'right': 4}
...
## Type: Padding
c.tabs.padding = {'top': 20, 'bottom': 20, 'left': 15, 'right': 15}
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'file:///home/sam/.config/startpage/index.html'
...
c.url.start_pages = ['file:///home/sam/.config/startpage/index.html']
...
config.bind('<Ctrl-f>', 'hint links spawn --detach mpv {hint-url}')
